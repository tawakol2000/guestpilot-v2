...
export const TRAINING_EXAMPLES: TrainingExample[] = [
  ...
  { text: 'Please', labels: [] },
  { text: 'Okay?', labels: [] },
  { text: 'Any update?', labels: [] },
  { text: 'Any updates?', labels: [] },
  { text: 'Hello?', labels: [] },
  { text: '?', labels: [] },
  { text: '??', labels: [] },
  { text: 'What about it?', labels: [] },
  { text: 'Is that possible?', labels: [] },
  { text: 'Can you?', labels: [] },
  { text: 'When?', labels: [] },
  { text: 'How much?', labels: [] },
  { text: 'How long?', labels: [] },
  { text: 'Really?', labels: [] },
  { text: 'Are you sure?', labels: [] },
  { text: 'طيب؟', labels: [] },
  { text: 'وبعدين؟', labels: [] },
  { text: 'يعني؟', labels: [] },
