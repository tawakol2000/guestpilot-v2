...
- TypeScript 5.x on Node.js 18+ + Express 4.x, OpenAI SDK (Responses API), Prisma ORM, Next.js 16 + React 19 (037-perfect-ai-mix)
- PostgreSQL + Prisma ORM, Redis (optional — BullMQ) (037-perfect-ai-mix)
